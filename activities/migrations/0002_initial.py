...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='activity',
            name='owner',
            field=models.ForeignKey(help_text='活動建立者', on_delete=django.db.models.deletion.CASCADE, related_name='created_activities', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='activity',
            name='category',
        ...
        migrations.AddField(
            ...
            name='activity',
            field=models.ForeignKey(help_text='活動', on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='activities.activity'),
        ),
        migrations.AddField(
            model_name='meetuppaticipat',
            name='participant',
